angular.module('uifordocker', [
    ...
    .config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/containers/:id/delete', {
            template: '<h1 ng-init="remove()"></h1>',
            controller: 'ContainerController'
        });
        ...
        $routeProvider.when('/file_manager', {
            templateUrl: 'app/components/fileManager/fileManager.html',
